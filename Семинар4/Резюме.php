...
$work = [
  ...
  'Description' =>
  [
    'Интересная работа, выходной можно организовать в любое время!',
    'Дизайн баннеров, верстка сайтов.',
    'Просто водитель, носишься по складу, "как белка в колесе"!'
  ]
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>
                <?php echo $work['Place'][0]; ?>
              </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $work['data'][0]; ?>
            </h6>
            <p>

              <?php echo $work['Post'][0]; ?>

            </p>
            <p>
              <?php echo $work['Description'][0]; ?>
            </p>
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>
                <?php echo $work['Place'][1]; ?>
              </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $work['data'][1]; ?>
            </h6>
            <p>
              <?php echo $work['Post'][1]; ?>
            </p>
            <p>
              <?php echo $work['Description'][1]; ?>
            </p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>
                <?php echo $work['Place'][2]; ?>
              </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $work['data'][2]; ?>
            </h6>
            <p>
              <?php echo $work['Post'][2]; ?>
            </p>
            <p>
              <?php echo $work['Description'][2]; ?>
            </p>
